    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                // 每个请求都会带上此参数
                formData: editor.getOpt('imageAddFormData'),
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    // 对网关返回的数据进行转换 转为 ueditor 返回格式
                    /**
                     * {
                     *      "status":200,
                     *      "result":{"filePath":"helpcenter\/20170803\/e315d563039040c990740889717cb22f.jpg",
                     *      "id":"fe20ecaf4ddcff1c6a48d4776feb809f"},
                     *      "message":null
                     * }
                     */
                    ...
                    if (json.status === 200 ) {
                        var path = '';
                        var imageAddFormData = editor.getOpt('imageAddFormData')
                        if (imageAddFormData && imageAddFormData.bucket == 'pic') {
                            path = json.result && json.result.filePath ? json.result.filePath.match(/pic\/(\S*)/)[1] : ''
                        }
                        else {
                            path = json.result && json.result.filePath ? json.result.filePath : ''
                        }
