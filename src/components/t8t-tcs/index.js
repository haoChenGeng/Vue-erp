...
function getDate() {
    var t = new Date,
        ...
        a = 10 > a ? "0" + a : a,
        t = t.getMilliseconds();
    return e.toString() + i.toString() + n.toString() + o.toString() + r.toString() + a.toString() + "." +
        t
}
...
function detectOS() {
    var t = navigator.userAgent,
        ...
        i = "Mac68K" == navigator.platform || "MacPPC" == navigator.platform || "Macintosh" == navigator.platform ||
...
if(debug) {
    // 开发环境跨域问题
    _submitAddr = 'http://localhost:8080/apis'
} else {
    _submitAddr = 'http://www.to8to.com/count/a682ab23d4b4c95f84c744b2826419cd.php'
}
