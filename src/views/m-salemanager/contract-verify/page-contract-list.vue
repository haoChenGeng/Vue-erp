        ...
        methods: {
            ...
            viewBtn(obj){
                if(typeof (obj) === 'object') {
                    this.$router.push({ path: '/sale-manage/contract-detail', query: { mode:'view', projectId: obj.projectId } })
                    return
                }
                if(this.$refs['contractTable'].states) {
                    let selectRow = this.$refs['contractTable'].states.currentRow
                    if (selectRow) {
                        this.$router.push({ path: '/sale-manage/contract-detail', query: { projectId: selectRow.projectId } })
                    } else {
            ...
            submitBtn(){
                ...
                if(this.$refs['contractTable'].states) {
                    ...
                    if (selectRow) {
                        ...
                        this.$router.push({ path: '/sale-manage/contract-detail', query: { projectId: selectRow.projectId,mode:'create' } })
                    } else {
                ...
                if(this.$refs['contractTable'].states) {
                    ...
                    if (selectRow) {
                        if(selectRow.processId && selectRow.state == 1) {
                            this.$router.push({ path: '/sale-manage/contract-detail', query: { procInsId: selectRow.processId,mode:'verify' } })
                        } else {
