<template>
    <div class="owner-intention-detail-page">
                        ...
                        <el-tabs v-model="activeInputTabName" @tab-click="tabClick">
                            <el-tab-pane label="项目信息" name="project">
                                <el-form
                                    ...
                                    <div class="dialog2-form-item-container">
                                        <el-form-item label="区域：" prop="standardTownId">
                                            <t8t-division
                                                :changeOnSelect="true"
                                                :filterable="true"
                                                :clearable="true"
                                                v-model="townArr"
                                                :value="townArr"
                                                :defaultValue="formData.standardTownId"
                                                :placeholder="选择区域"
                                                :disabled="!editForm"
                                    ...
                                    <div class="dialog2-form-item-container">
                                        <el-form-item label="是否交房：" prop="transferStatus">
                                            <el-select v-model="formData.transferStatus" placeholder="--请选择--" :disabled="!editForm" @change="transferChange">
                                                <el-option v-for="item in propertyData[33007]" :label="item.name" :value="item.id">
                                                </el-option>
                                            </el-select>
                                        </el-form-item>
                                    </div>
                                    <div class="dialog2-form-item-container">
                                        <el-form-item label="预计交房时间：" prop="expectTransferTime">
                                            <t8t-datetime-picker endFormater="timestamp" :bindValue="formData.expectTransferTime"
                                                                 v-model="formData.expectTransferTime" type="date" :disabled="!editTransfer">
                                            </t8t-datetime-picker>
                                        </el-form-item>
                                    </div>
                                    <div class="dialog2-form-item-container">
        ...
        <el-dialog title="审核结果" v-model="auditDialog" @close="closeRedDialog" ref="auditDialogRef">
            <el-form
                ...
                <el-form-item label="" prop="recordTime">
                    <t8t-datetime-picker endFormater="timestamp" :bindValue="auditFormData.recordTime"
                                         v-model="auditFormData.recordTime" type="date" :disabled="!auditFormData.editGoOn">
                </t8t-datetime-picker>
                </el-form-item>
                <!--<el-form-item label="" prop="recordTime">-->
                    <!--<el-date-picker-->
            ...
            <div slot="footer">
                <el-button type="primary" @click="runAudit" element-loading-text="提交中">提交</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            doEdit(){
                editForm = true
                this.$router.push({
                    path: '/tuchat-sale-manage/page-potential-owner-list/edit',
            ...
            changeRadio(val){
                if(val == 3) {
                    ...
                    this.$set(this.auditRules,'recordTime',[
                        {
                            required: true,
                            message: '请选择跟进时间'
                        }
...
//                        rows.addedRows.qq = rows.addedRows.qqId
            ...
            closeDialog() {
                this.$router.push({ path: '/tuchat-sale-manage/page-intention-owner-list'})
                this.$emit('close')
            },
...
<style>
    .owner-intention-detail-page .t8t-form-popup .el-input {
        width: 180px;
        line-height: 32px;
    }
</style>
