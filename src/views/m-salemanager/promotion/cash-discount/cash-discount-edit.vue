                ...
                >
                        ...
                        <div class="form-item-container" v-if="formData.parValueType==2">
                            <el-form-item label="单个面值上限："  prop="maxParValue">
                                <el-input  v-model ="formData.maxParValue" v-on:blur="getPrivilegeRental" ></el-input>
                            </el-form-item>
                        </div>
                        <div class="form-item-container">
                ...
                >
                    ...
                    <div class="form-item-container">
                         <el-form-item label="可使用组织范围：">
                            <!-- <el-input  v-model="formData.effectiveOrgNames" icon="search" readonly @click="showOrg" :value="jhnxund"></el-input> -->
                ...
                if(isValid)
                {
                        ...
                        formData.effectiveTime = this.changeTime(formData.effectiveTime)*/
                         var args = {
                            ...
                            cashDiscountApi.updateSubmit(args)
                                .then((res) => {
                                    if(res.data.status === 200){
                                        // 新增成功
                ...
                if(isValid)
                {
                        ...
                        formData.effectiveTime = this.changeTime(formData.effectiveTime)*/
                         var args = {
                            ...
                            cashDiscountApi.updateSave(args)
                                .then((res) => {
                                    if (res.data.status === 200) {
                                         this.isLoading = false
                                        this.$msgbox({
                                        ...
                                        this.disabledSymbols.pop()
                                        this.getData(this.$route.query.rowId);*/
                                    }else{
                                        this.$message({
                                            type: 'error',
                                             message: res.data.message
