      ...
      <div class="t8t-full-dialog2-container">
        ...
        <div class="full-dialog-toolbar-container">
          <div class="toolbar-container">
            ...
            <t8t-toolbar class="t8t-dark" @SUBMIT="SubmitBtn" :symbolList="symbolList" ref="indexToolbar">
            </t8t-toolbar>
          </div>
        </div>
          ...
          <div class="table-list-container">
            <el-tabs v-model="activeTabName" @tab-click="clickTab">
              ...
              <div class="table-list">
                <el-tab-pane label="工艺信息" name="changeContent">
                  <el-form class="dialog2-form-container" :model="formData" ref="formRef" :rules="formRules" label-position="right" label-width="100px">
                  ...
                  <el-tabs v-model="editableTabsValue" type="card" closable @tab-remove="removeTab">
                    <el-tab-pane v-for="(item, index) in craftTabs" :label="item.title" :name="item.name" :key="index" class="create-title-tab">
                      ...
                      <upload @blur="getBlur" @delete="deleteUpload" @deletePic="deleteUploadPic" :key="index1" :index="index1" :item="item1" v-for="(item1,index1) in item.content" ref="upload">
                      </upload>
  ...
  methods: {
    ...
    add(title, index) {
      if (this.craftTabs[index].content.length > 9) {
        ...
        setTimeout(() => {
          this.$refs.upload[index].$el.scrollIntoView(true);
        }, 0);
        // console.log(this.craftTabs);
      }
    },
