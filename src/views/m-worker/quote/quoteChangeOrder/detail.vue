                    ...
                    methods.create(
                        ...
                        if( res.data.status == 200 ){
                            ...
                            if( !this.isEmpty(res.data.result) && this.isEmpty(this.orderId) ){
                                ...
                                this.$router.push({path:'/tuchat-worker/quote-changeorder-detail',query:{'yid':this.yid,'orderId':this.orderId}})
                                //this.$router.push({path:'/tuchat-worker/quote-changeorder-list',query:{'yid':this.yid,'orderId':this.orderId}})
                            }
            ...
            submitDo: function (){
                ...
                methods.submit(_this.orderId, +Cookie.get('t8t-tc-uid')).then(res => {
                    return this.$msgbox({
                        ...
                        'message': '提交成功',
                        callback:function (){
                            _this.$router.push('/tuchat-worker/quote-changeorder-list')
                        }
                    })
                }).catch(e => {
