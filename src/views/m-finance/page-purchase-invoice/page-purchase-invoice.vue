    ...
    export default {
        ...
        methods: {
            ...
            addClick() {
                ...
                this.$router.push({path: '/tuchat-finance/page-purchase-invoice/create'})
            },
            //参照对账单新增
            autoAddClick() {
                this.$TCS.addTag('erp_finance_007008001002')
                this.$router.push({path: '/tuchat-finance/page-purchase-invoice/create', query: {type:'auto'}})
            },
            //修改
            editClick() {
                ...
                //手动新增
                this.$router.push({path: '/tuchat-finance/page-purchase-invoice/edit', query: {id: selectRow.id,type:'edit'}})
            },
            //查看
            viewClick() {
                ...
                if (this.checkSelection() === false) return false
                let selectRow = this.$refs['t8tTable'].getSelectRows()[0]
                this.$router.push({ path: '/tuchat-finance/page-purchase-invoice/view', query: { id: selectRow.id } })
            },
            //作废
            voidClick(){
                ...
                if(selectRow['orderStatus'] == 3 && selectRow['verifyStatus'] != 3 ) {
                    if(selectRow['colorType'] == 2) {
                        ...
                        this.$confirm('是否确定对所选发票做核销？', '核销确认', {
                            ...
                            this.$router.push({path: '/tuchat-finance/page-purchase-invoice/writeOff', query: {id: selectRow.id}})
                        })
                    }
                }else{
                    this.$msgbox({
