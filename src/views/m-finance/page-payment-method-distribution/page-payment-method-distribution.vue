...
<script>
    ...
    export default {
        ...
        methods: {
            //点击新增按钮
            btnAddClick() {
                this.$router.push({path: '/tochat-finance/page-payment-method-distribution/create', query: {editType: "add"}})
            },
            btnEditClick() {
                // 编辑
                ...
                if (selections.length === 0) {
                    ...
                    this.$router.push({
                        path: '/tochat-finance/page-payment-method-distribution/create',
