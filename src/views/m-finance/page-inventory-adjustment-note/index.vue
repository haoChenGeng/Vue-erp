...
//                this.$router.push({path: '/finance/page-inventory-adjustment-note/view', query: {id: this.curRow.id}})
            },
            onView(symbol, event) {
...
//                this.$router.push({path: '/finance/page-purchase-verification-sheet/view', query: {id: selectRow.id}})
//            },
            //提交搜索
            onSearchSubmit(obj) {
