...
//                this.showDialog('view')
                this.$router.push({path: '/tochat-finance/page-purchase-verification-sheet/view', query: {id: row.id}})
            },
//            onView(symbol, event) {
//                if(!this.selRows){
...
//            },
            ...
            onView (symbol, event) {
                ...
                this.$router.push({path: '/tochat-finance/page-purchase-verification-sheet/view', query: {id: this.curRow.id}})
            },
