...
<script>
    ...
    import apiInventoryAccounting from 'src/services/finance/goodsCostPrice.js'
        ...
        methods: {
            btnDownloadClick(){
                ...
                exportUtils({
                    ...
                    title: '商品成本单价',
                    headers: '成本域,会计期间,商品编码,商品名称,商品类别,规格,型号,基础单位,不含税单价,计算时间',
                    sorts: 'costDomainName,accountingTimeStr,goodsCode,goodsName,goodsCategoryName,goodsStandard,goodsModel,basicUnitName,costPrice,calculateTimeStr'
                })
            },
            getExportArgs(param){
                let exportP = {...param}
