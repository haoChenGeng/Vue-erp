...
//            },
        ...
        data () {
            return {
                ...
                // 详情页路由地址
                viewRoute:'/tuchat-finance/page-voucher-template/view',// 查看按钮
                editRoute:'/tuchat-finance/page-voucher-template/edit',// 编辑按钮
                addRoute:'/tuchat-finance/page-voucher-template/add',// 新增按钮
