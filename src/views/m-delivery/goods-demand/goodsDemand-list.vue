    ...
    export default {
        ...
        data () {
            ...
            return {
                ...
                receiptsRoute: '/tuchat-delivery/demand-receipts',
                editRoute: '/tuchat-delivery/demand-receipts',
            ...
            doEdit () {
                ...
                if (selections.length > 0) {
                    ...
                    if(selections[0].replenishType == 1 && selections[0].orderStatus == 5){
                        this.$router.push({path: '/tuchat-delivery/demand-edit', query: {id:selections[0].id}})
                    }else{
