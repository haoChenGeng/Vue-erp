<template>
    <div class="send-list">
        ...
        <div class="g-main-container send-list-class">
    ...
    export default {
        ...
        methods: {
            ...
            showDetail() {
                ...
                this.$TCS.addTag('red_20553_031003004001');
                let row = selections[0];
                this.$router.push({ path: '/tuchat-delivery/demand-view', query: { id: row.id, status: 1 } })
            },
