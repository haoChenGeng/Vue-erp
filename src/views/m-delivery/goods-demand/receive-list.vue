<template>
    <div class="receive-list">
        ...
        <div class="g-main-container receive-list-class">
    ...
    export default {
        ...
        methods: {
            ...
            showDetail() {
                ...
                this.$router.push({ path: '/tuchat-delivery/demand-view', query: { id: row.id, status: 2 } })
            },
