<template>
    <div class="wait-send-list">
        <t8t-search :fields="fields"
            :selectSource="selectSource"
            @submit="submitSearch"
            ref="tableSearch">
        </t8t-search>
        <div class="g-main-container wait-send-list-class">
            <div class="g-main-container-column">
                ...
                <t8t-table class="wait_send_list"
                    :columns="columns"
                    :service="service"
                    :method="method"
                    :args="args"
    ...
    export default {
        ...
        methods: {
            ...
            showDetail() {
                ...
                this.$router.push({ path: '/tuchat-delivery/demand-view', query: { id: row.id, status: 0 } })
            },
