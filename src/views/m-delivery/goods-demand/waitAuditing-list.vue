<template>
    <div class="wait-auditing-list">
        <t8t-search :fields="fields"
            :selectSource="selectSource"
            @submit="submitSearch"
            ref="tableSearch">
        </t8t-search>
        <div class="g-main-container wait-auditing-list-class">
            <div class="g-main-container-column">
                ...
                <t8t-table class="wait_auditing_list"
                    :columns="columns"
                    :service="service"
                    :method="method"
                    :args="args"
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                symbolList: ['VIEW', 'PASS', 'REBUT', 'CANCEL', 'EXPORT'],
                //搜索表单项配置
                fields: [
        ...
        methods: {
            ...
            showDetail() {
                ...
                this.$router.push({ path: '/tuchat-delivery/demand-view', query: { id: row.id, status: 4 } })
            },
