        ...
        methods: {
            ...
            closeDialog() {
                if(pageType == "measure-approval") {
                    ...
                    this.$router.push({ path: '/tuchat-delivery/measure-list' })
                }
            },
            ...
            edit(){
                ...
                this.$router.replace({ path: '/tuchat-delivery/measure-edit', query: {id: this.orderId } })
            },
            submit(){
                               ...
                               let _this = this
                                if(res.data.status == 200) {
                                    this.$msgbox({
                                        ...
                                        _this.$router.push({ path: '/tuchat-delivery/measure-list'})
                                    })
                                }else{
                                    this.$msgbox({
                                        title: '消息',
