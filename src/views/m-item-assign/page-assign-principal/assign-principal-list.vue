        ...
        methods: {
            ...
            assignDelivery: function () {
                ...
                if (selectRow == null)
                    return
                // 派单-交付经理
                this.$refs['list-view'].doView('/tochat-itemAssign/assign-principal-delivery-page', 'projectId')
            },
            assignProject: function (row, abc) {
                ...
                // 派单-工程管家
                this.$refs['list-view'].doView('/tochat-itemAssign/assign-principal-project-page', 'projectId')
            },
            assignItemManager: function () {
                ...
                // 派单-项目经理
                this.$refs['list-view'].doView('/tochat-itemAssign/assign-principal-item-page', 'projectId')
            },
            assignCustomerService: function () {
                ...
                // 派单-项目经理
                this.$refs['list-view'].doView('/tochat-itemAssign/assign-principal-customer-service-page', 'projectId')
            },
