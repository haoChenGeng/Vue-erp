        ...
        <div class="t8t-full-dialog-container">
            ...
            <div class="full-dialog-form-container container-center">
                <el-form :model="formData" :rules="formRule" ref="formRef" label-position="right" label-width="120px">
                    ...
                    <div class="form-item-container">
                    <el-form-item label="售后客服：" prop="objId">
                        <el-input v-model="viewData.customerService" :readonly="true">
                        </el-input>
                    </el-form-item>
                </div>
                    <div class="form-item-container">
                        <el-form-item label="详细地址：" prop="objId">
                            <el-input type="textarea" autosize v-model="viewData.address" :title="viewData.address"
                                      :readonly="true">
                            </el-input>
                        </el-form-item>
                    </div>
                ...
                <el-tabs v-model="activeTabName">
                    <div class="my-container">
                        <div class="container-center">
                            <el-form>
                                <div class="form-item-container">
                                    <el-form-item label="派单原因：" ref="reasonSelect" prop="reason"
                                                  v-if="viewData.projectManager != '未分配'">
                                        <el-select v-model="reason" placeholder="--请选择--">
                                            <el-option v-for="item in commonOptionsConfig.assignReasons"
        ...
        methods: {
            ...
            submitForm: function (symbol) {
                if (this.principalRow == null || this.principalRow['accountId'] == null) {
                    this.$message.error('请选择工程管家后再试！')
                    return
                }

                if (this.viewData['projectManager'] !== '未分配' && this.reason <= 0) {
                ...
                this.isLoading = true
                itemAssignServiceApi.principalAssignCustomer(args).then((res) => {
                    var msgType = ''
                    var msg = ''
